...
def test_likes_food
  result = likes_food(@person2, "bread")
...
def test_add_friend
  ...
  def test_total_of_everyones_money
    total_money(@people)
    assert_equal(143, @person1[:monies] + @person2[:monies] + @person3[:monies] + @person4[:monies] + @person5[:monies])
  end
